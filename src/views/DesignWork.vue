...
const caseStudies = [
  ...
  },
  {
    ...
    role: "Product Designer",
    duration:
      "Initial design: 1 month | Iterations ongoing based on user feedback",
...
const designPrinciples = [
  {
    title: "User-Centered",
    description:
      "Every design decision starts with understanding user needs, pain points, and goals.",
    icon: "user",
  },
  {
    title: "Data-Informed",
    description:
      "Combining qualitative insights with quantitative data to validate design choices.",
    icon: "chart",
  },
  {
    title: "Accessible",
    description:
      "Designing inclusive experiences that work for everyone, regardless of ability.",
    icon: "accessibility",
  },
  {
    title: "Systematic",
  ...
  <main class="pt-24 lg:pt-32">
      ...
      <div class="max-w-7xl mx-auto">
        <div class="max-w-3xl">
          <AnimatedSection animation="fade-up">
            <span
              class="text-primary font-medium text-sm uppercase tracking-widest mb-4 block"
            >
              Design Work
            </span>
          </AnimatedSection>
          ...
          <AnimatedSection animation="fade-up" :delay="100">
            <h1
              class="font-display text-4xl md:text-5xl lg:text-6xl font-bold text-foreground mb-6 text-balance"
            >
          ...
          <AnimatedSection animation="fade-up" :delay="150">
            <p class="text-lg text-muted-foreground leading-relaxed">
              ...
              solving complex design problems. Each project represents a journey
              from research to final delivery.
            </p>
          </AnimatedSection>
        </div>
      </div>
    ...
    <SectionWrapper size="md" class="bg-muted/30">
      <div class="max-w-7xl mx-auto">
        <AnimatedSection animation="fade-up">
          <h2
            class="font-display text-2xl md:text-3xl font-bold text-foreground mb-8"
          >
            Design Philosophy
          </h2>
        </AnimatedSection>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          >
            <div
              class="bg-card border border-border rounded-xl p-5 h-full hover:border-primary/50 transition-colors duration-300"
            >
              <div
              ...
              >
                ...
                <!-- Accessibility Icon -->
                <svg
                  v-if="principle.icon === 'accessibility'"
                  class="w-5 h-5 text-primary"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          >
            <RouterLink :to="`/case-studies/${study.slug}`" class="block group">
              <article
                class="bg-card border border-border rounded-2xl overflow-hidden hover:border-primary/50 hover:shadow-xl hover:shadow-primary/5 transition-all duration-400"
              >
                <!-- Image -->
                <div class="relative aspect-[16/10] overflow-hidden bg-muted">
                  ...
                  />
                  <div
                    class="absolute inset-0 bg-gradient-to-t from-card/90 via-transparent to-transparent"
                  />

                  <!-- Role badge -->
                  <div class="absolute bottom-4 left-4 flex items-center gap-3">
                    <span
                      class="px-3 py-1.5 text-xs font-medium rounded-full bg-primary/90 text-primary-foreground"
                    >
                      {{ study.role }}
                    </span>
                ...
                <div class="p-6">
                  ...
                  <p
                    class="text-muted-foreground text-sm leading-relaxed mb-4 line-clamp-2"
                  >
                    {{ study.description }}
                  </p>
